...
<html>
  <head>
    ...
    <link rel="stylesheet" href='{{url("css/allgames.css")}}' />
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <script src='{{url("js/allgames.js")}}' defer></script>
      ...
      <div class="section">
        <div class="cart_container">
          <div id="carrellobello">
            ...
            <div class="inputbar">
              <input id="input" type="search" placeholder="Cerca" />
              <img src="img/icons/Vector.png" id="search" />
            </div>
          </div>
